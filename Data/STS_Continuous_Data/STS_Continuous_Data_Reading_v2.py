...
# Using this file requires openpyxl
...
station[2023] = pd.read_excel(station_paths[2023])
...
for year in  station.keys():
    ...
    print(list(pd.unique(valid["Station ID"])))
