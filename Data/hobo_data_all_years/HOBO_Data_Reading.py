...
#Beebe Cove
paths[2]= config["Beebe_Cove_Reading_path"]

#Mumford Cove
paths[3]=config["Mumford_Cove_Reading_path"]
...
strings={}
#Beebe sensor code for temp field
strings[1]= config["Beebe_Sensor_Data"]

#Mumford sensor code for temp field
strings[2]= config["Mumford_Sensor_Data"]
