...
# Source for raw data nad monitoring stations (all data is downloaded (no API) from this link:
# https://uriwatershedwatch-uri.hub.arcgis.com/pages/data-download
