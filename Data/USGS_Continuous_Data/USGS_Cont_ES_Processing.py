...
#Loading station dict (ultimately dates should be removed from these)
station_file="USGS_Cont_ES_Stations.csv"
input_file="USGS_Cont_ES_Pre_Processing.csv"
output_file="USGS_Cont_ES_Interpolated.csv"
pre_output_file="USGS_Cont_ES_Processed.csv"
...
#Only temp data
input_data=input[dep_vars+alt_dep_vars].copy()
print(len(input_data.loc[input_data["Temperature"].isna()]))
input_data.bfill(axis=1, inplace=True)
print(len(input_data.loc[input_data["Temperature"].isna()]))
