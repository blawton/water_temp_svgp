...
method="SVGP"
spatial_pca= False
notes="This version uses SVGP based on GPFlow documentation, with a fixed sin kernel added (uses Adam not LFBGS)"
model_name="3.6"
...
#Filename
filename="agg_daily_morning_coastal_features.csv"
